...
public class TaskListRs extends Protocol{
	private DecodeClassProHandler dch = new DecodeClassProHandler();
	private EncodeClassProHandler ech = new EncodeClassProHandler();
	public static short code = 1703;
	//任务列表
	private List<com.dykj.rpg.protocol.task.TaskRs> taskList;
	public TaskListRs(){
		this.taskList = new ArrayList<>();
	}
	public TaskListRs(List<com.dykj.rpg.protocol.task.TaskRs> taskList){
	...
	public String toString() {
		return "TaskListRs [code=" + code +",taskList=" + taskList +"]";
	}
}
