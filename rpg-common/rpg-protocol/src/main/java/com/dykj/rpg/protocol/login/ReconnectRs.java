...
public class ReconnectRs extends Protocol{
	private DecodeClassProHandler dch = new DecodeClassProHandler();
	private EncodeClassProHandler ech = new EncodeClassProHandler();
	public static short code = 1109;
	//玩家信息
	private com.dykj.rpg.protocol.player.PlayerRs player;
	public ReconnectRs(){
	}
	public ReconnectRs(com.dykj.rpg.protocol.player.PlayerRs player){
		this.player = player;
	}
	public void release(){
		this.dch.release();
	...
	public String toString() {
		return "ReconnectRs [code=" + code +",player=" + player +"]";
	}
}
