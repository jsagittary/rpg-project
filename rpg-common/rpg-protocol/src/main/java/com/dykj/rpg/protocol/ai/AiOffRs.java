...
public class AiOffRs extends Protocol{
	private DecodeClassProHandler dch = new DecodeClassProHandler();
	private EncodeClassProHandler ech = new EncodeClassProHandler();
	public static short code = 1905;
	//卸下的雕纹信息
	private com.dykj.rpg.protocol.item.ItemRs item;
	public AiOffRs(){
	}
	public AiOffRs(com.dykj.rpg.protocol.item.ItemRs item){
		this.item = item;
	}
	public void release(){
		this.dch.release();
	...
	public String toString() {
		return "AiOffRs [code=" + code +",item=" + item +"]";
	}
}
