...
public class ReadMailRs extends Protocol{
	private DecodeClassProHandler dch = new DecodeClassProHandler();
	private EncodeClassProHandler ech = new EncodeClassProHandler();
	public static short code = 2004;
	private com.dykj.rpg.protocol.mail.MailRs mail;
	public ReadMailRs(){
	}
	public ReadMailRs(com.dykj.rpg.protocol.mail.MailRs mail){
		this.mail = mail;
	}
	public void release(){
		this.dch.release();
	...
	public String toString() {
		return "ReadMailRs [code=" + code +",mail=" + mail +"]";
	}
}
