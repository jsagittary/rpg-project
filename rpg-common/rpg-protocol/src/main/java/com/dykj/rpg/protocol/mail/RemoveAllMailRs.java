...
public class RemoveAllMailRs extends Protocol{
	private DecodeClassProHandler dch = new DecodeClassProHandler();
	private EncodeClassProHandler ech = new EncodeClassProHandler();
	public static short code = 2006;
	//邮件列表
	private List<com.dykj.rpg.protocol.mail.MailRs> mails;
	public RemoveAllMailRs(){
		this.mails = new ArrayList<>();
	}
	public RemoveAllMailRs(List<com.dykj.rpg.protocol.mail.MailRs> mails){
		this.mails = mails;
	}
	public void release(){
		this.dch.release();
	...
	public String toString() {
		return "RemoveAllMailRs [code=" + code +",mails=" + mails +"]";
	}
}
