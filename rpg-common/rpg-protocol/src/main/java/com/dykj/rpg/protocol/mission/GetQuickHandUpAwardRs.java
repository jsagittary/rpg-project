...
public class GetQuickHandUpAwardRs extends Protocol{
	private DecodeClassProHandler dch = new DecodeClassProHandler();
	private EncodeClassProHandler ech = new EncodeClassProHandler();
	public static short code = 1510;
	//快速挂机的次数，为0的时候表示一次快速挂没有使用。客户端显示免费（第一次免费）
	private int quickHangUpNum;
	//快速挂机重置的时间搓，客户端做倒计时用
	private long quickHangUpTime;
	public GetQuickHandUpAwardRs(){
	}
	public GetQuickHandUpAwardRs(int quickHangUpNum,long quickHangUpTime){
	...
	public String toString() {
		return "GetQuickHandUpAwardRs [code=" + code +",quickHangUpNum=" + quickHangUpNum +",quickHangUpTime=" + quickHangUpTime +"]";
	}
}
