...
public class RemoveMailRs extends Protocol{
	private DecodeClassProHandler dch = new DecodeClassProHandler();
	private EncodeClassProHandler ech = new EncodeClassProHandler();
	public static short code = 2008;
	private com.dykj.rpg.protocol.mail.MailRs mail;
	public RemoveMailRs(){
	}
	public RemoveMailRs(com.dykj.rpg.protocol.mail.MailRs mail){
		this.mail = mail;
	}
	public void release(){
		this.dch.release();
	...
	public String toString() {
		return "RemoveMailRs [code=" + code +",mail=" + mail +"]";
	}
}
