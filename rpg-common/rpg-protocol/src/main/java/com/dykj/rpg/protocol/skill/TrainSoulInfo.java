...
public class TrainSoulInfo extends Protocol{
	private DecodeClassProHandler dch = new DecodeClassProHandler();
	private EncodeClassProHandler ech = new EncodeClassProHandler();
	public static short code = 1414;
	//技能id
	private int skillId;
	//位置
	private int trainSoulPos;
	public TrainSoulInfo(){
	}
	public TrainSoulInfo(int skillId,int trainSoulPos){
	...
	public String toString() {
		return "TrainSoulInfo [code=" + code +",skillId=" + skillId +",trainSoulPos=" + trainSoulPos +"]";
	}
}
