...
public class ReceiveTaskRewardsRs extends Protocol{
	private DecodeClassProHandler dch = new DecodeClassProHandler();
	private EncodeClassProHandler ech = new EncodeClassProHandler();
	public static short code = 1707;
	//任务列表
	private List<com.dykj.rpg.protocol.task.TaskRs> taskList;
	public ReceiveTaskRewardsRs(){
		this.taskList = new ArrayList<>();
	}
	public ReceiveTaskRewardsRs(List<com.dykj.rpg.protocol.task.TaskRs> taskList){
	...
	public String toString() {
		return "ReceiveTaskRewardsRs [code=" + code +",taskList=" + taskList +"]";
	}
}
