...
public class PlayerSkillRs extends Protocol{
	private DecodeClassProHandler dch = new DecodeClassProHandler();
	private EncodeClassProHandler ech = new EncodeClassProHandler();
	public static short code = 1402;
	private List<com.dykj.rpg.protocol.skill.SkillRs> skills;
	public PlayerSkillRs(){
		this.skills = new ArrayList<>();
	}
	public PlayerSkillRs(List<com.dykj.rpg.protocol.skill.SkillRs> skills){
		this.skills = skills;
	}
	public void release(){
		this.dch.release();
	...
	public String toString() {
		return "PlayerSkillRs [code=" + code +",skills=" + skills +"]";
	}
}
