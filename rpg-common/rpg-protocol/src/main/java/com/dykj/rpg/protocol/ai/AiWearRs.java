...
public class AiWearRs extends Protocol{
	private DecodeClassProHandler dch = new DecodeClassProHandler();
	private EncodeClassProHandler ech = new EncodeClassProHandler();
	public static short code = 1903;
	//穿上的雕纹信息
	...
	public AiWearRs(com.dykj.rpg.protocol.item.ItemRs upItem,com.dykj.rpg.protocol.item.ItemRs downItem){
		this.upItem = upItem;
	...
	public String toString() {
		return "AiWearRs [code=" + code +",upItem=" + upItem +",downItem=" + downItem +"]";
	}
}
