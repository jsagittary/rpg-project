...
public class LoginMsgRs extends Protocol{
	private DecodeClassProHandler dch = new DecodeClassProHandler();
	private EncodeClassProHandler ech = new EncodeClassProHandler();
	public static short code = 1104;
	//玩家信息
	private com.dykj.rpg.protocol.player.PlayerRs player;
	public LoginMsgRs(){
	}
	public LoginMsgRs(com.dykj.rpg.protocol.player.PlayerRs player){
		this.player = player;
	}
	public void release(){
		this.dch.release();
	...
	public String toString() {
		return "LoginMsgRs [code=" + code +",player=" + player +"]";
	}
}
