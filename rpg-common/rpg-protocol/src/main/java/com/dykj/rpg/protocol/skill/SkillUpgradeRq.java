...
public class SkillUpgradeRq extends Protocol{
	private DecodeClassProHandler dch = new DecodeClassProHandler();
	private EncodeClassProHandler ech = new EncodeClassProHandler();
	public static short code = 1408;
	//道具id
	private int itemId;
	//道具数量
	private int itemNum;
	public SkillUpgradeRq(){
	}
	public SkillUpgradeRq(int itemId,int itemNum){
		this.itemId = itemId;
	...
	public String toString() {
		return "SkillUpgradeRq [code=" + code +",itemId=" + itemId +",itemNum=" + itemNum +"]";
	}
}
