 ...
 * @Description:
 */
public class RemoveMailHandler extends GameHandler<RemoveMailRq> {
	private Logger logger = LoggerFactory.getLogger(getClass());

	@Override
	public void doHandler(RemoveMailRq removeMailRq, Player player) {
		ErrorCodeEnum errorCodeEnum = BeanFactory.getBean(MailService.class).removeMail(player,removeMailRq);
