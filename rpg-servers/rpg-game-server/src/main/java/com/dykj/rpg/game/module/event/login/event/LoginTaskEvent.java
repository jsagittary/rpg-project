 ...
 */
@Component
public class LoginTaskEvent extends AbstractEvent
{
    ...
    public void doEvent(Object... prams) throws Exception
    {
        ...
        this.initGrandTotal(player, playerTaskCache);
        ...
        TaskResponse taskResponse = taskService.triggerTaskPush(player, TaskOpenConditionEnum.DEFAULT);
     ...
     * @param player 玩家信息
     */
    private void initGrandTotal(Player player,  PlayerTaskCache playerTaskCache)
    {
