 ...
 * @Description:
 */
public class ReadMailHandler extends GameHandler<ReadMailRq> {
	private Logger logger = LoggerFactory.getLogger(getClass());

	@Override
	public void doHandler(ReadMailRq readMailRq, Player player) {
		ErrorCodeEnum errorCodeEnum = BeanFactory.getBean(MailService.class).readMail(player, readMailRq);
