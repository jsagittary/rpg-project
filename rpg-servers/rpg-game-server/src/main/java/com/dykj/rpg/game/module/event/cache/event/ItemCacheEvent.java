 ...
 */
@Component
public class ItemCacheEvent extends CacheEvent<PlayerItemCache>
{
    ...
    public void loadFromDb(Player player)
    {
        ...
        if (null == playerItemCache || playerItemCache.values().isEmpty())
        {
    ...
    {
        Collection<PlayerItemModel> playerItemModels = player.cache().getPlayerItemCache().values();
        if (!player.cache().getPlayerItemCache().values().isEmpty())
        {
            ...
            {
                this.initCurrency(player, player.cache().getPlayerItemCache());
            }
        }
    }
    ...
    private void initCurrency(Player player, PlayerItemCache playerItemCache)
    {
        ...
        if (null != collection && !collection.isEmpty())
        {
            ...
            {
                if ((itemModel.getItemType() == ItemTypeEnum.CURRENCY.getItemType() && (itemModel.getItemTypeDetail() == ItemTypeEnum.CurrencyTypeEnum.RECHARGE_DIAMOND.getSubclassType() || itemModel.getItemTypeDetail() == ItemTypeEnum.CurrencyTypeEnum.BIND_DIAMOND.getSubclassType() || itemModel.getItemTypeDetail() == ItemTypeEnum.CurrencyTypeEnum.GOLD.getSubclassType())))
                {
