...
public class ObjImporter {
    ...
    private class ObjImporterContext {
        ...
        List<Integer> meshFaces = new ArrayList<Integer>();
    }

    public GameInputGeomProvider load(InputStream is) {
        ...
        return new GameInputGeomProvider(context.vertexPositions, context.meshFaces);
