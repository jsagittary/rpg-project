...
public class RecastMeshBuilder {
    ...
    public RecastMeshBuilder(InputGeomProvider m_geom) {
    ...
    public RecastMeshBuilder(InputGeomProvider m_geom, PartitionType m_partitionType, float m_cellSize,
